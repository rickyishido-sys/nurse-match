...
import { generateDailyRecommendations, getCurrentUser, getDailyRecommendationCards } from '@/lib/data';
          ...
          cards.map((card) => (
            <article key={card.user.id} className='space-y-3 rounded-3xl border border-slate-100 bg-white p-4 shadow-sm'>
              <div className='flex gap-3'>
                <div className='relative h-[92px] w-[92px] shrink-0 overflow-hidden rounded-2xl border border-slate-200'>
