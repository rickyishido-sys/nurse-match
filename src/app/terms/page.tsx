...
const SECTIONS: { heading: string; body?: string; items?: string[] }[] = [
  ...
  {
    heading: '参加決定時のサービス利用料',
    body: 'HANAKAIでは、イベントへの参加申請が主催者に承認され、参加が決定した時点で、参加者から1回につき500円（税込）のサービス利用料をいただきます。',
    items: [
      'サービス利用料は、主催者が参加申請を承認し、参加が確定した場合に発生します',
      'イベント自体の参加費は、主催者が別途設定・徴収する場合があります',
      'HANAKAIは、イベント売上に対する歩合・売上連動型の手数料は受け取りません',
      '参加決定前の申請段階では、サービス利用料は発生しません',
      '決済方法、キャンセル時の取扱い等は、アプリ内の案内および本規約の該当条項に従うものとします',
    ],
  },
  {
    heading: '本人確認',
