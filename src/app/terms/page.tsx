...
const SECTIONS: { heading: string; body?: string; items?: string[] }[] = [
  ...
  },
  {
    ...
    items: [
      ...
      '当日はイベント詳細画面からチェックインを行うこと',
    ],
  },
  {
    heading: '開催場所・店舗への確認',
    items: [
      '開催場所の管理者・店舗等へ、イベント開催について事前確認・必要な許可を取得することは主催者の責任です',
      '参加費を徴収する場合は、その旨を開催場所へ事前に説明すること',
      '店舗・会場へ請求する場合は、請求について事前了承を得ること',
    ],
  },
  {
    heading: '売上報告・送客サービス利用料',
    body: 'HANAKAIはイベント参加費を徴収するサービスではありません。HANAKAIを通じて送客した分に対し、成果報酬型の送客サービス利用料をいただきます。',
    items: [
      'イベント終了後、主催者はイベント全体の実参加人数・税込売上・税率・証憑（レシート・領収書・POS画面等）を報告する義務があります',
      '虚偽の売上報告は禁止します',
      '送客サービス利用料は、HANAKAIを通じて実際に参加した方に相当する税抜売上の10％（税抜）とします',
      '請求時には送客サービス利用料（税抜）に別途消費税を加算します',
      '送客割合は HANAKAIチェックイン人数 ÷ イベント全体の実参加人数 で算出します',
    ],
  },
  {
    heading: '本人確認',
