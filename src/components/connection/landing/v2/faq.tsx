...
const FAQS = [
  ...
  { q: 'イベント参加後も交流できますか？', a: 'はい。イベント参加者限定のConnectionグループを通じて、イベント後も交流を続けることができます。', accent: HK.violet },
  { q: '勧誘目的でも参加できますか？', a: 'いいえ。営業、宗教、ネットワークビジネス、投資勧誘などを目的とした参加は禁止しています。違反が確認された場合は、利用停止となる場合があります。', accent: HK.amber },
  { q: '安全対策はありますか？', a: '安心して参加いただけるよう、運営による監視・通報機能・本人確認機能を用意しています。問題が発生した場合には運営が対応いたします。', accent: HK.sky },
] as const;
