-- Fix: hanakai_expire_overdue_participation_payments referenced
-- hanakai_event_applications.updated_at, which does not exist on that table.
-- Apply AFTER 20260802_hanakai_square_payments.sql (Preview yyaz only).
